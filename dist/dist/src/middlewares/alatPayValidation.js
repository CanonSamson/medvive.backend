 ...
 */
export const validateTransactionStatusRequest = (req, res, next) => {
 ...
 */
export const validateVirtualAccountRequest = (req, res, next) => {
    const requestId = Math.random().toString(36).substring(7);
...
//# sourceMappingURL=alatPayValidation.js.map
//# sourceMappingURL=alatPayValidation.js.map