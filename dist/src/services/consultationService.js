...
export class ConsultationService {
    ...
    async bookNewConsultation({ date, time, patientSymptoms, consultationId: consultationId = uuidv4() }) {
    ...
    async cancelConsultation({ consultationId, cancelMassage = '' }) {
        ...
        try {
            ...
            if (consultation.success && consultation.data) {
                ...
                await updateDBAdmin('consultations', consultationId, updatedConsultations);
