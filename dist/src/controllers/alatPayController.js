 ...
 */
export const generateVirtualAccount = asyncWrapper(async (req, res) => {
    const requestData = req.body;
    // Basic validation
    const requiredFields = ['amount', 'currency', 'orderId', 'description', 'customer'];
 ...
 */
export const getServiceStatus = asyncWrapper(async (req, res) => {
    try {
 ...
 */
export const confirmTransactionStatus = asyncWrapper(async (req, res) => {
...
//# sourceMappingURL=alatPayController.js.map